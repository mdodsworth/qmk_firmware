...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______,      _______, _______,    LCTL(KC_C), _______,    _______,    _______, _______,    _______, _______, KC_TILD, _______,          _______, _______,              KC_VOLU,          \
        _______,      _______, _______,                                        _______,                                        _______, _______, _______, _______,     KC_MRWD, KC_VOLD, KC_MFFD  \
    ),
};
